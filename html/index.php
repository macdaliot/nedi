...
<html>
<head>
	<title>NeDi 1.4.300</title>
	<meta name="generator" content="NeDi 1.4.300">
...
<body onLoad="document.login.user.focus();">
	<form name="login" method="post" action="index.php?goto=<?= urlencode($goto) ?>">
		<table class="login">
			...
			<tr class="loginbg">
				<th>
					User <input type="text" name="user" style="width:150px">
				</th>
				<th>
					Pass <input type="password" name="pass" style="width:150px">
				</th>
				<th>
