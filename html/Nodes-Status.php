...
?>
		...
		<tr class="txta">
			...
			<td class="drd">
				...
				<a href="Nodes-Stolen.php?stl=<?= $n[0] ?>&dev=<?= $ud ?>&ifn=<?= $ui ?>" title="Nodes-Stolen <?= $addlbl ?>" class="frgt"><img src="img/16/step.png"></a>
...
?>
			<td class="<?= $statbg ?>" colspan="2">
				<img src="img/<?= $ntimg ?>" title="<?= $irow ?>) <?= $ntit ?>">
				...
				<a href="Nodes-Toolbox.php?Dest=<?= $ip ?>" class="frgt"><img src="img/16/tool.png" title="Nodes-Toolbox"></a>
